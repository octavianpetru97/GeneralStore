...
$get_product = "select * from customer_orders where customer_id='$customer_id'";

$run_customer = mysqli_query($con,$get_product);
...
<body>
   ...
   <?php
    echo "invoice no = ".var_dump($get_product);
   ?>
               ...
               <div class="box"><!-- box Begin -->
                  ...
                  <form action="confirm.php?update_id=<?php echo $order_id;  ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> PayPal / Stripe / Western Union Code: </label>
